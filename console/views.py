...
from webvirtmgr_v1.settings import WS_PORT
from webvirtmgr_v1.settings import WS_PUBLIC_HOST
...
def console(request):
    ...
    if console_type == 'vnc':
        response = render(request, 'console/console-vnc.html', locals())
    elif console_type == 'spice':
        response = render(request, 'console/console-spice.html', locals())
    else:
